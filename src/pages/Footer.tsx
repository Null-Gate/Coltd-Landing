        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <Link to={"/"} className="flex items-center md:h-[200px]">
                <img src={logo} className="h-full w-full object-cover" alt="KarGate Logo" />
          ...
          <hr className=" border-gray-200 my-8 lg:mt-0 lg:mb-8" />
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-white sm:text-center ">
              © 2023{" "}
              <a href="https://KarGate.com/" className="hover:underline">
                KarGate™
              </a>
              . All Rights Reserved.
            </span>
