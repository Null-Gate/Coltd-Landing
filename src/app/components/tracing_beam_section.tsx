...
import { TracingBeam } from "@/utils/tracing_beam";
      ...
      <div className="max-w-2xl mx-auto antialiased pt-4 relative">
        {dummyContent.map((item, index) => (
          <div key={`content-${index}`} className="mb-10">
            ...
            <div className="text-sm  prose prose-sm dark:text-neutral-300 text-neutral-800 dark:prose-invert">
              {item?.image && (
                <Image
                  src={item.image}
                  alt="blog thumbnail"
